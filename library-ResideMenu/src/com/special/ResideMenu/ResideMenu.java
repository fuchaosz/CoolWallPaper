...
public class ResideMenu extends FrameLayout {
    ...
    protected boolean fitSystemWindows(Rect insets) {
        ...
        this.setPadding(viewActivity.getPaddingLeft() + insets.left, viewActivity.getPaddingTop() + insets.top, viewActivity.getPaddingRight() + insets.right, bottomPadding);
    ...
    public void setSwipeDirectionEnable(int direction) {
        disabledSwipeDirection.remove(new Integer(direction));
    }
}
